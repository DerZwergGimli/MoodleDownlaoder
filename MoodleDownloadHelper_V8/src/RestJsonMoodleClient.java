import java.io.BufferedReader;
    ...
    public class RestJsonMoodleClient {
        ...
        public static void main(String[] args) throws ProtocolException, IOException {
            ...
            /// NEED TO BE CHANGED
            String token = "d095e4a410225eac990e8221285d5697";
            String domainName = "http://moodle.htwg-konstanz.de";
            ...
            // Send request
            String serverurl = domainName + "/moodle/index.php" + "?wstoken=" + token + "&wsfunction=" + functionName;
