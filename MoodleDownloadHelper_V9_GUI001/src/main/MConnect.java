...
{ 
	...
	public void seturlSiteInMoodle(String urlSiteInMoode) 
	{
		this.urlSiteInMoode = urlSiteInMoode;
	}
	...
	public String getUrlSiteInMoode() 
	{
		return this.urlSiteInMoode; 
	}
	...
	public void createDocument()
	{
			...
			urlSiteInMoode = response.url().toString();
			
		
		try {
			document = Jsoup
					.connect(urlSiteInMoode)
	...
	{
		this.urlSiteInMoode = response.url().toString();
	}
