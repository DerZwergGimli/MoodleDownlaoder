...
public class main 
{
	...
	public static void main(String[] args) throws IOException 
	{
		...
		Response resultImageResponse = Jsoup.connect(url).cookies(res.cookies())
                .ignoreContentType(true).execute();
		System.out.println(resultImageResponse.url());
		
		FileOutputStream out = (new FileOutputStream(new java.io.File("XXX.pdf")));
		out.write(resultImageResponse.bodyAsBytes());  // resultImageResponse.body() is where the image's contents are.
		out.close();
		
		System.out.println("55555555555555555555555555555555555555555555555555555555555555555555555555555555555555555555555555");
		
		 try {

	            //connectionTimeout, readTimeout = 10 seconds
	            FileUtils.copyURLToFile(new URL(linkPDF), new File("test.html"), 10000, 10000);
